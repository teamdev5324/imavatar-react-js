...
const ResetPassword = () => {
 ...
 - Special characters ! @ # $ % & ^ ( ) _ - + =; : ? / , .`
  ...
  const { values, errors, handleChange, handleSubmit, setFieldError, touched } =
    useFormik({
      initialValues,
      validationSchema,
      ...
      onSubmit: async () => {
        ...
        const config = {
          ...
          url: 'http://52.90.60.5:8080/api/user/noAuth/changePassword',
          headers: {
                  ...
                  <form class="reset">
                    <div class="col-md-12 frmss mb-4">
                      ...
                      <input
                        ...
                        style={{ paddingLeft: 50, paddingRight: 35 }}
